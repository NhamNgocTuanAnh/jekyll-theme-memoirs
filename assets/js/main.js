...
function isTetDate() {
  ...
  document.querySelector(".menuTrigger").addEventListener("click",function(){this.classList.toggle("active"),console.log("Clicked menu");let e=document.getElementById("menuList");e.classList.toggle("show_list"),e.classList.contains("show_list")?e.style.display="block":e.style.display="none"})
