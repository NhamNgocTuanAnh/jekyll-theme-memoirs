...
{% include responsive-image.html path='assets/images/nan-nhan-cong-kich-ca-nhan.jpg' alt="Sulli đã phải hứng chịu rất nhiều chỉ trích từ cộng đồng mạng kể từ sau khi rời f(x). (Ảnh: Yonhap)" %}
...
{% include responsive-image.html path='assets/images/con-nha-ngta.jpg' %}
...
{% include responsive-image.html path='assets/images/ngon-ngu-viet-phong-phu.png' alt= "Ngôn ngữ việt rất phong phú" %}
